  ...
  static List<Upgrade> getDefaultUpgrades() {
    return [
      ...
      Upgrade(
        ...
        cost: Decimal.fromInt(500000),
        type: UpgradeType.clickPower,
        effectValue: 10.0,
        icon: '👆✨',
        requirementId: 'upg_click_5x',
      ),
      Upgrade(
        id: 'upg_click_25x',
        name: 'Ultra Clicking',
        description: '25x click power',
        cost: Decimal.fromInt(10000000),
        type: UpgradeType.clickPower,
        effectValue: 25.0,
        icon: '👆🔥',
        requirementId: 'upg_click_10x',
      ),
      Upgrade(
        id: 'upg_click_50x',
        name: 'Hyper Clicking',
        description: '50x click power',
        cost: Decimal.fromInt(1000000000),
        type: UpgradeType.clickPower,
        effectValue: 50.0,
        icon: '👆💥',
        requirementId: 'upg_click_25x',
      ),
      Upgrade(
        id: 'upg_click_100x',
        name: 'God Clicking',
        description: '100x click power',
        cost: Decimal.parse('100000000000'),
        type: UpgradeType.clickPower,
        effectValue: 100.0,
        icon: '👆⚡',
